...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.academic.terms.store', $schoolYear) }}" method="POST" class="px-4 py-5 sm:p-6">
                @csrf
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    <a href="{{ route('admin.academic.terms', $schoolYear) }}" class="btn btn-secondary">Annuler</a>
