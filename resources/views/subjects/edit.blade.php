...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Modifier la Matière</h3>
            <p class="mt-1 text-sm text-gray-500">Mettez à jour les informations de la matière</p>
        </div>

        <form action="{{ route('admin.subjects.update', $subject) }}" method="POST" class="px-4 py-5 sm:p-6">
            @csrf
            @method('PUT')
